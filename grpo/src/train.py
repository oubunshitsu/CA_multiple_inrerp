...
from reward_funcs import reward_answer, reward_slot
...
parser = HfArgumentParser((CustomGRPOConfig, CustomLoraConfig), allow_abbrev=False)
...
trainer = GRPOTrainer(
    ...
    args=training_args,
    reward_funcs=[reward_answer, reward_slot],
