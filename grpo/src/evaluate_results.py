...
def main():
    ...
    # Baseline
    # common_dir = "use_all_annotations/grpo/results/baseline"
    # SFT
    # common_dir = "use_all_annotations/sft/results/logic_parsing_dataset/conversational_style/deepspeed_zero2"
